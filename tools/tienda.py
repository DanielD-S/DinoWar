...
PIEZAS = {
    ...
    'retrato_cientifico': ('assets/piel/tienda/retrato_cientifico.webp', 512),
    'retrato_cientifica': ('assets/piel/tienda/retrato_cientifica.webp', 512),
    'retrato_cazador': ('assets/piel/tienda/retrato_cazador.webp', 512),
    'retrato_trex': ('assets/piel/tienda/retrato_trex.webp', 512),
    'estandarte_helecho': ('assets/piel/tienda/estandarte_helecho.webp', 360),
    'cinta_helecho': ('assets/piel/tienda/cinta_helecho.webp', 480),
    'medallon_hell_creek': ('assets/piel/tienda/medallon_hell_creek.webp', 680),
    'medallon_kem_kem': ('assets/piel/tienda/medallon_kem_kem.webp', 680),
    ...
    'retrato_supersaurus': ('assets/piel/tienda/retrato_supersaurus.webp', 512),
    'retrato_hesperosaurus': ('assets/piel/tienda/retrato_hesperosaurus.webp', 512),
    'retrato_harpactognathus': ('assets/piel/tienda/retrato_harpactognathus.webp', 512),
