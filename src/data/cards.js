...
export const CARTAS = Object.freeze({
  ...
  plesiopleurodon: dino({
    id: 'plesiopleurodon', rareza: RAREZA.COMUN, clado: CLADO.MARINO,
  ...
  ojoraptorsaurus: dino({
    id: 'ojoraptorsaurus', rareza: RAREZA.COMUN, clado: CLADO.TEROPODO,
  ...
  suchomimus: dino({
    id: 'suchomimus', rareza: RAREZA.COMUN, clado: CLADO.TEROPODO,
  ...
  carnotaurus: dino({
    id: 'carnotaurus', rareza: RAREZA.COMUN, clado: CLADO.TEROPODO,
  ...
  spinosaurus: dino({
    id: 'spinosaurus', rareza: RAREZA.COMUN, clado: CLADO.TEROPODO,
  ...
  mosasaurus: dino({
    id: 'mosasaurus', rareza: RAREZA.COMUN, clado: CLADO.MARINO,
  ...
  scanisaurus: dino({
    id: 'scanisaurus', rareza: RAREZA.COMUN, clado: CLADO.MARINO,
  ...
  monolophosaurus: dino({
    id: 'monolophosaurus', rareza: RAREZA.COMUN, clado: CLADO.TEROPODO,
  ...
  invictarx: dino({
    id: 'invictarx', rareza: RAREZA.COMUN, clado: CLADO.TIREOFORO,
  ...
  medusaceratops: dino({
    id: 'medusaceratops', rareza: RAREZA.COMUN, clado: CLADO.MARGINOCEFALO,
  ...
  alaskacephale: dino({
    id: 'alaskacephale', rareza: RAREZA.COMUN, clado: CLADO.MARGINOCEFALO,
  ...
  titanoceratops: dino({
    id: 'titanoceratops', rareza: RAREZA.COMUN, clado: CLADO.MARGINOCEFALO,
  ...
  atlasaurus: dino({
    id: 'atlasaurus', rareza: RAREZA.COMUN, clado: CLADO.SAUROPODO,
  ...
  maiasaura: dino({
    id: 'maiasaura', rareza: RAREZA.COMUN, clado: CLADO.ORNITOPODO,
  ...
  edmontosaurus: dino({
    id: 'edmontosaurus', rareza: RAREZA.COMUN, clado: CLADO.ORNITOPODO,
  ...
  gargoyleosaurus: dino({
    id: 'gargoyleosaurus', rareza: RAREZA.COMUN, clado: CLADO.TIREOFORO,
  ...
  wendiceratops: dino({
    id: 'wendiceratops', rareza: RAREZA.COMUN, clado: CLADO.MARGINOCEFALO,
  ...
  domeykosaurus: dino({
    id: 'domeykosaurus', rareza: RAREZA.COMUN, clado: CLADO.SAUROPODO,
  ...
  antarctosaurus: dino({
    id: 'antarctosaurus', rareza: RAREZA.COMUN, clado: CLADO.SAUROPODO,
  ...
  rhinorex: dino({
    id: 'rhinorex', rareza: RAREZA.COMUN, clado: CLADO.ORNITOPODO,
