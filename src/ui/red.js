...
//
// Es el único fichero que sabe DÓNDE vive el estado de la tribu. Hoy vive en
// este navegador y los compañeros los simula el propio juego; el día que haya
// servidor se reescribe este fichero y nada más.
//
// La superficie es de cuatro funciones a propósito. Todo lo que no esté aquí no
// habrá que reescribirlo:
//
//   estadoDeTribu(ahora)     cómo va el almacén, el jefe y quién aportó
//   aportar(fosiles, ahora)  sumo al común
//   asaltar(dano, ahora)     le hago daño al jefe
//   reclamar(ahora)          cojo lo que me toca de un jefe caído
//
// LO QUE ESTO NO ES: multijugador. Hasta que haya servidor, tus compañeros de
// tribu no son personas — son un modelo de lo que haría una tribu, con las
// mismas reglas y los mismos números. El bucle de un jugador es idéntico; la
// gente al otro lado no está. Se dice aquí para que nadie lo descubra jugando.
