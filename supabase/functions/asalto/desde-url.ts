...
//
// Motor anclado en: 4a524c89d18ed15881a9095881cc7b3b75d0c2f8

import { createClient } from 'jsr:@supabase/supabase-js@2';
import {
  validarAsalto, jefeDelEvento, AsaltoInvalido,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/supabase/functions/_compartido/validarAsalto.js';
import {
  validarSolitario,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/supabase/functions/_compartido/validarSolitario.js';
import {
  crearDuelo, aplicarAccion, vistaDuelo, comprobarTiempo, rendirse, resultado, terminado,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/supabase/functions/_compartido/duelo.js';
import { validarMazoLegal } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/supabase/functions/_compartido/validarPartida.js';
import { eloTras } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/src/data/ligas.js';
import { CUENCA } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/src/data/tribu.js';
import { ECONOMIA, abrirSobre } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/src/data/coleccion.js';
import {
  avancesDelParte, diaUTC, POR_ID,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/src/data/misiones.js';
import { rivalPorId, requisitoDe, claveDeVictoria } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/src/data/expediciones.js';
import { avancesDeLogros } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@4a524c89d18ed15881a9095881cc7b3b75d0c2f8/src/data/logros.js';
