...
//
// Motor anclado en: ce63c4c293e3b5bf8b856a58e302fa654ec01d04

import { createClient } from 'jsr:@supabase/supabase-js@2';
import {
  validarAsalto, jefeDelEvento, AsaltoInvalido,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/supabase/functions/_compartido/validarAsalto.js';
import {
  validarSolitario,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/supabase/functions/_compartido/validarSolitario.js';
import {
  crearDuelo, aplicarAccion, vistaDuelo, comprobarTiempo, rendirse, resultado, terminado, partesDe,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/supabase/functions/_compartido/duelo.js';
import { validarMazoLegal } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/supabase/functions/_compartido/validarPartida.js';
import { eloTras, temporadaDe, eloVigente, conEscudo } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/src/data/ligas.js';
import { CUENCA } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/src/data/tribu.js';
import { ECONOMIA, abrirSobre } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/src/data/coleccion.js';
import {
  avancesDelParte, diaUTC, POR_ID,
} from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/src/data/misiones.js';
import { rivalPorId, requisitoDe, claveDeVictoria } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/src/data/expediciones.js';
import { avancesDeLogros } from 'https://cdn.jsdelivr.net/gh/DanielD-S/DinoWar@ce63c4c293e3b5bf8b856a58e302fa654ec01d04/src/data/logros.js';
